...
for j in indices_run:
    ...
    det_params,trans_params = estimate_blur(rads,sod,odd,pix_wid,thresh=1e-6,pad=[3,3],edge='straight-edge',power=norm_pow,save_dir=sdir,only_det=True)
