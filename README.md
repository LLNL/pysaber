**THIS README IS FOR OLDER VERSION (v0.*.*) OF PYSABER THAT IS INSTALLED USING PIP AS FOLLOWS -**
```bash
    pip install pysaber
```
**DOCUMENTATION FOR LATEST VERSION OF PYSABER, FOR CURRENT SOURCE CODE, WILL BE PROVIDED SOON THROUGH READTHEDOCS.**
